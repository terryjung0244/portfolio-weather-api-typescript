...
import { WeatherFailureType, WeatherRequestType, WeatherSuccessType } from './weatherAction.interface';
...
export const getWeatherApiRequestAction = (currentLocation: CurrentLocationType): WeatherRequestType => {
  return {
...
export const getWeatherApiSuccessAction = (dataFromServer: weatherModel): WeatherSuccessType => {
  return {
